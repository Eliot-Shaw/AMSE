...
class Ex7k extends StatelessWidget {
  static const String nomExercice = "Recherche dans les fichiers telephone";

  const Ex7k({super.key});
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(Ex7k.nomExercice),
